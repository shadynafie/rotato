...
export type LeaveType = 'annual' | 'study' | 'sick' | 'professional' | 'paternity' | 'maternity';
...
export const LeaveTypes = ['annual', 'study', 'sick', 'professional', 'paternity', 'maternity'] as const;
